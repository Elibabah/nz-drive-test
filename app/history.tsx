...
const dash = StyleSheet.create({
  ...
  label: { color: 'rgba(255,255,255,0.55)', fontSize: 11, textAlign: 'center', marginTop: 2 },
  divider: { width: 1, height: 40, backgroundColor: 'rgba(255,255,255,0.08)' },
  weekText: { color: 'rgba(255,255,255,0.55)', fontSize: 13, textAlign: 'center' },
  ...
  sparkLabel: { color: 'rgba(255,255,255,0.5)', fontSize: 11, marginBottom: 4 },
});
...
const styles = StyleSheet.create({
  ...
  count: { color: 'rgba(255,255,255,0.55)', fontSize: 13, fontWeight: '600', letterSpacing: 0.5 },
  ...
  cardMetaText: { color: 'rgba(255,255,255,0.55)', fontSize: 12 },
  cardMetaSep: { color: 'rgba(255,255,255,0.35)', fontSize: 12 },
  cardRight: { flexDirection: 'row', alignItems: 'baseline', gap: 2 },
  cardScore: { fontSize: 26, fontWeight: '800' },
  cardScoreLabel: { color: 'rgba(255,255,255,0.5)', fontSize: 13 },
